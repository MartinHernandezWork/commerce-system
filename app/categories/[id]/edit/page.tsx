...
export default function EditCategoryPage() {
  ...
  if (loading) {
    return (
      <div className="flex h-full min-h-0 flex-col items-center justify-center rounded-3xl border border-slate-200 bg-[#f6f8f7]">
        <div className="flex flex-col items-center gap-3 text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-green-50">
            <FolderPen className="h-6 w-6 text-green-600" />
          </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-green-50">
              <FolderPen className="h-5 w-5 text-green-600" />
            </div>
          ...
          >
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Actualizá el nombre de esta categoría.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-400">
                Podés modificar el nombre y guardar los cambios.
              </p>
            </div>
